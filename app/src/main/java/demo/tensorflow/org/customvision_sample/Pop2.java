...
public class Pop2 extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button browse = (Button) findViewById(R.id.button42);
        browse.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.nhs.uk/conditions/psoriasis/treatment/")));
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(Pop2.this, ClassifierActivity.class));
            }
        });
